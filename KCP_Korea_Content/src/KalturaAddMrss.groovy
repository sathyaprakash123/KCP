...
class KalturaAddMrss extends PluginCommand

{
    ...
    static String FileExtension = "_Add_MRSS.xml" //Extension name for mrss file
...

    {
        ...
        context.logInfo("ObjectID is " + objectId)
        ...
        try {
            ...
            Element action = CreateElement(item, "action", "add");
            ...
            //Element userId = CreateElement(item, "userId", Season_UDO_Metadata.getField("ta-partner").value.toString());
            ...
            Element media = CreateElement(item, "media", null);
            Element mediaType = CreateElement(media, "mediaType", "1");
            ...
            //Element OTTTAGProvider = CreateElement(metadata, "OTTTAGProvider", Season_UDO_Metadata.getField("provider").value.toString());
            ...
            Element distributions = CreateElement(item, "distributions", null);
            Element distribution = CreateElement(distributions, "distribution", null);
            Element distributionProfileId = CreateElement(distribution, "distributionProfileId", DistributionProfileId);
            Element sunrise = CreateElement(distribution, "sunrise", "2018-01-01T00:00:00");
            Element sunset = CreateElement(distribution, "sunset", "2035-12-30T00:00:00");
