...
class KalturaUpdateMetadataOnly extends PluginCommand

{
    // Created by Sathya, Apr, 2018. Update Kaltura Series Mrss.
...

    {
        ...
        try {
            ...
            context.setStringVariable("update_type", "metadata")
